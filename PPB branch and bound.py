...
weights = [49,41,29,22,26,26,13,20,19,21]    #weights of items
capacity = 100           #capacity of each box
numItems = len(weights) #number of items 
...
print( binPacking(numItems, capacity, weights) )